...
def shopSmart(orderList, fruitShops):
    ...
    for i in range(len(fruitShops)):
        if min(cheapestAmount, fruitShops[i].getPriceOfOrder(orderList)) != cheapestAmount:
            cheapestAmount = fruitShops[i].getPriceOfOrder(orderList)
            cheapestShop = fruitShops[i]
